...
train_data_set = ImageFolder(r"D:\Face_IQA\dataset\CASIA-FASD\cbsr_antispoofing\frame\face\CNN\train", transform=transforms.Compose([transforms.ToTensor(), transforms.Resize((128, 128))]))
test_data_set = ImageFolder(r"D:\Face_IQA\dataset\CASIA-FASD\cbsr_antispoofing\frame\face\CNN\val", transform=transforms.Compose([transforms.ToTensor(), transforms.Resize((128, 128))]))
